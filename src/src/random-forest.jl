...
function dt_train(x_train, y_train)
   ...
   #regressor = skl_t.RandomForestRegressor()
   #regressor.fit(x_train, y_train)

   regr = skl_t.DecisionTreeRegressor()
...
for i in 1:5
   ...
   println(metri.accuracy_score(folds_pg[i][2],pg_pred))
...
file = "data/predictions/" * name_train * "/rf-results-load1.pkl"
